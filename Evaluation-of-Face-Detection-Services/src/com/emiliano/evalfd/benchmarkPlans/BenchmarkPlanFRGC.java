...
public class BenchmarkPlanFRGC extends BenchmarkPlanImpl<FaceDetectionInput, FaceDetectionOutput> {

	public BenchmarkPlanFRGC(String name, Context context, FaceDetectionServiceClient faceServiceClient) {
		super(name, context);
	...
	private void addInputs() {
		...
		List<FaceDetectionInput> list = DataSetUtils.getInputsFRGC();
